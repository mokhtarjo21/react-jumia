...
function CategoryPage() {
  ...
  const fetchSubCategories = async () => {
    ...
    try {
      ...
      console.log("sub categories", data.children);
  ...
  const categories = [
    ...
    },
    {
      ...
      title: "Headsets",
      imageSrc:
        "https://images.unsplash.com/photo-1583394838336-acd977736f90?q=80&w=2831&auto=format&fit=crop",
    ...
    },
    {
      ...
      title: "Wearables",
      imageSrc:
        "https://images.unsplash.com/photo-1617043786394-f977fa12eddf?q=80&w=2942&auto=format&fit=crop",
    ...
    },
    {
      ...
      title: "Cases",
      imageSrc:
        "https://images.unsplash.com/photo-1603313011638-94aa4778ed99?q=80&w=2070&auto=format&fit=crop",
      href: "/category/cases",
    },
    {
      id: "accessories",
      title: "Accessories",
      imageSrc:
        "https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?q=80&w=2978&auto=format&fit=crop",
    ...
    },
    {
      ...
      title: "Screens",
      imageSrc:
        "https://images.unsplash.com/photo-1511385348-a52b4a160dc2?q=80&w=3107&auto=format&fit=crop",
  ...
  return (
    <div className="container-fluid category-page">
      {/* { category_details.children.length } */}
