      ...
      <div className="card p-3 shadow-sm">
        <div className="row">
          ...
          <div className="col-md-7">
            <h5>{info.name}</h5>
            <div className="mb-2">
              <span className="text-danger fs-5 fw-bold">EGP {info.sale_price}</span>
              <span className="text-muted text-decoration-line-through ms-2">EGP {info.price}</span>
            ...
            <div className="text-muted small mb-2">Free delivery to 6th of October</div>
